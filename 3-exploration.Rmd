...
```{r gdpdata, fig.cap="Données PIB par habitant pour l'année 2021, par continent", layout="l-body-outset", fig.width=6, fig.height=4}
# Graphique :

ggplot(data = stats_gdp_pays,
       aes(x = GDP.per.capita.growth...., y = name, color = continent)) +
  geom_histogram()
